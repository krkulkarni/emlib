...
#     """Holds data arrays for a single subject."""
#     choices: np.ndarray  # Shape (n_trials,) or (n_blocks, n_trials)
#     rewards: np.ndarray  # Shape matches choices
#     craving_ratings: np.ndarray # Shape matches choices
#     mood_ratings: np.ndarray # Shape matches choices
